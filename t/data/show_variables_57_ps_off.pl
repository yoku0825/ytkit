package Ytkit::Test::SHOW_VARIABLES_57_PS_OFF;
...
$VAR1 = {
          ...
          'character_sets_dir' => {
                                    'Value' => '/usr/mysql/5.7.22/share/charsets/',
          ...
          'pid_file' => {
                          'Value' => '/usr/mysql/5.7.22/data/mysql.pid',
          ...
          'gtid_executed' => {
                               'Value' => 'ffddcaee-4448-11e8-8e12-0201a32caf75:1-10',
          ...
          'plugin_dir' => {
                            'Value' => '/usr/mysql/5.7.22/lib/plugin/',
          ...
          'server_uuid' => {
                             'Value' => 'ffddcaee-4448-11e8-8e12-0201a32caf75',
          ...
          'relay_log_index' => {
                                 'Value' => '/usr/mysql/5.7.22/data/relay.index',
          ...
          'relay_log_basename' => {
                                    'Value' => '/usr/mysql/5.7.22/data/relay',
          ...
          'socket' => {
                        'Value' => '/usr/mysql/5.7.22/data/mysql.sock',
          ...
          'log_bin_basename' => {
                                  'Value' => '/usr/mysql/5.7.22/data/bin',
          ...
          'log_bin_index' => {
                               'Value' => '/usr/mysql/5.7.22/data/bin.index',
