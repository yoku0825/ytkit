...
my $test=
{
  ...
  "5.6.49" => { mysqld => "/usr/mysql/5.6.49/bin/mysqld", mysql_install_db => "/usr/mysql/5.6.49/scripts/mysql_install_db" },
  "5.7.31" => { mysqld => "/usr/mysql/5.7.31/bin/mysqld" },
  "8.0.21" => { mysqld => "/usr/mysql/8.0.21/bin/mysqld" },
};
