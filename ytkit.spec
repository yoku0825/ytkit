...
Requires:	perl 
Requires:       perl(DBD::mysql) perl(Time::Piece) perl(Carp) perl(JSON) perl(Term::ReadKey) perl(Data::Dumper) perl(Time::HiRes) perl(Parallel::ForkManager) perl(Term::ANSIColor)
AutoReq:        no
BuildArch:      noarch
